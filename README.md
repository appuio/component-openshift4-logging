...
This is a [Commodore][commodore] Component for OpenShift4 Logging.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/openshift4-logging).
