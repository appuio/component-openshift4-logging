...
kubectl --as=system:admin -n syn patch apps openshift4-logging --type=json \
  -p '[{"op":"replace", "path":"/spec/syncPolicy", "value": {}}]'
----
...
[source,bash]
----
kubectl --as=system:admin -n openshift-logging delete sub cluster-logging
----
...
[source,bash]
----
kubectl --as=system:admin -n openshift-logging delete og cluster-logging
----
...
[source,bash]
----
kubectl --as=system:admin -n openshift-logging delete csv -l operators.coreos.com/cluster-logging.openshift-logging=
----
